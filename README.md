...
*  `findRoute()` ကို ပြင်ပြီး Direct Route အရင်ဆုံး ရှာဖွေပြီး ရှိလျှင် အခြား 1-transfer / 2-transfer logic မပြန်လည်စစ်ဆေးတော့ပါ။ ဒါကြောင့် တိုက်ရိုက်ရောက်နိုင်သောကားတွေ ရှိနေပြီးကျန်ကားတွေ ထပ်မရှာတော့တဲ့ bug ကို ဖြေရှင်းလိုက်ပါသည်။
*  `findDirectRoutes()` ကို `normalize()` နဲ့ `includes()` သုံးပြီး မှတ်တိုင်အမည်ရှာဖွေရန် ပိုမိုလွယ်ကူစေပြီး space / suffix အနည်းငယ်ကွာခြားမှုတွေကိုလည်း ပြုပြင်ပေးလိုက်ပါသည်။
*  Serverless environment မှာ `json(req)` မရှိသေးတဲ့ bug ကို `req.body` သို့ ပြောင်းပြီး Vercel စသည့် deployment များမှာ ပိုမိုထိရောက်စေလိုက်ပါသည်။
